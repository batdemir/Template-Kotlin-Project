...
object Libraries {
    ...
    val lifecycleCommon = Dependency("androidx.lifecycle:lifecycle-common-java8:${Versions.androidxLifeCycleCommonVersion}")
    ...
    val lifecycleViewModelSavedState = Dependency("androidx.lifecycle:lifecycle-viewmodel-savedstate:${Versions.androidxLifeCycleStateVersion}")
    val multidex = Dependency("androidx.multidex:multidex:${Versions.androidxMultidex}")
    val navigationCompose = Dependency("androidx.navigation:navigation-compose:${Versions.androidxNavigationVersion}")
